...
export const testimonials: Testimonial[] = [
  { id: "1", name: "Sarah Chen", role: "Fashion Blogger", avatar: "https://picsum.photos/seed/sarah-chen/100/100", text: "The quality exceeded my expectations. Every piece feels premium and the packaging was beautiful. This is my new go-to shop.", rating: 5 },
  { id: "2", name: "Marcus Rivera", role: "Tech Enthusiast", avatar: "https://picsum.photos/seed/marcus-rivera/100/100", text: "Incredible selection of electronics at competitive prices. Fast shipping and the customer service team was very helpful.", rating: 5 },
  { id: "3", name: "Emily Watson", role: "Interior Designer", avatar: "https://picsum.photos/seed/emily-watson/100/100", text: "Curated with such care. The home decor pieces transformed my apartment. Will definitely be ordering more.", rating: 4 },
  { id: "4", name: "James Park", role: "Fitness Coach", avatar: "https://picsum.photos/seed/james-park/100/100", text: "Top-notch sports gear that actually performs. The quality matches premium brands at a fraction of the price.", rating: 5 },
];
