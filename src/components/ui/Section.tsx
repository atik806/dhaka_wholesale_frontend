  ...
  return (
    <div className={cn("flex items-end justify-between gap-6 mb-6", className)}>
      <div className="min-w-0">
        {eyebrow && <p className="label-caps text-accent-text mb-1.5">{eyebrow}</p>}
      ...
      {href && (
        <Link
          href={href}
          className="hidden sm:inline-flex items-center gap-1.5 shrink-0 text-sm font-semibold text-link hover:text-link-hover transition-colors"
        >
          {linkLabel}
